...
| **Original** in `imgs` directory<br><img src="imgs/sandy.JPG" style="height: 256px">  | **Aligned** with `align.py`<br><img src="imgs_align/sandy.png" style="height: 256px;"> | **Manipulated** with `manipulate.ipynb`<br><img src="imgs_manipulated/sandy-wavyhair.png" style="height: 256px;"> |
|---|---|---|
